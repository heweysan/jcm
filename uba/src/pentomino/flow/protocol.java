...
public class protocol extends kermit {
	...
	public void processing(byte[] jcmResponse) {
		...
		case INVALID_COMMAND: // 0x4b Invalid Command
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- INVALID COMMAND", jcmResponse, jcmResponse[1]));
			break;
		case ACK: // 0x50 ACK
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- ACK", jcmResponse, jcmResponse[1]));
		...
		case SR_ACCEPTING: // 0x12 ACCEPTING
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- ACCEPTING", jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			PanelDeposito.depositTimer.restart();
			EventListenerClass.fireMyEvent(new MyEvent("accepting" + jcmId));
			break;
		case SR_ESCROW: // 0x13 ESCROW
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- ESCROW", jcmResponse, jcmResponse[1]));
		...
		case SR_STACKING: // 0x14 STACKING +DATA
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- STACKING [" + currentInsertedBill + "]", jcmResponse, jcmResponse[1]));
		...
		case SR_VEND_VALID: // 0x15 VEND_VALID
			...
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- VEND_VALID [" + currentInsertedBill + "]", jcmResponse, jcmResponse[1]));
		...
		case SR_STACKED: // 0x16 STACKED +DATA
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- STACKED", jcmResponse, jcmResponse[1]));
		...
		case SR_REJECTING: // 0x17 REJECTING
			if (mostrar)
				System.out
				.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- REJECTING", jcmResponse, jcmResponse[1]));
			...
			if(jcmId == 1) {
				...
				System.out.println("DEPOSITANDO 1 FALSE");
				PanelDeposito.depositando1 = false;				
			}
			if(jcmId == 2) {
				PanelDeposito.bussy2 = false;
				System.out.println("DEPOSITANDO 2 FALSE");
				PanelDeposito.depositando2 = false;
			}
		...
		case SR_RETURNING: // 0x18 RETURNING
			if (mostrar)
				System.out
				.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- RETURNING", jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
		...
		case SR_HOLDING: // 0x19 HOLDING
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- HOLDING", jcmResponse, jcmResponse[1]));
		...
		case SR_INHIBIT: // 0x1A DISABLE (INHIBIT)
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- DISABLE (INHIBIT)", jcmResponse, jcmResponse[1]));
			...
			//ESte va primero ya que el siguiente lo setea y si este esta despues pues lo va a hacer.
			if(currentOpertion == jcmOperation.CollectCass2) { 
				System.out.println("JCM[" + jcmId + "] DISABLE (INHIBIT) CollectCass2");
				if(jcmId == 1) {					
			...
			if(currentOpertion == jcmOperation.CollectCass1) {
				System.out.println("JCM[" + jcmId + "] DISABLE (INHIBIT) CollectCass1");
				if(jcmId == 1) {
		...
		case SR_INITIALIZE: // 0x1B INITIALIZE
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- INITIALIZE", jcmResponse, jcmResponse[1]));
		...
		case SR_PAYING: // 0x20 PAYING
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- PAYING", jcmResponse, jcmResponse[1]));
			break;

		case SR_COLLECTING: // 0x21 COLLECTING
			if (mostrar)
				System.out
				.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- COLLETING", jcmResponse, jcmResponse[1]));
			break;

		case SR_COLLECTED: // 0x22 COLLECTED + DATA
			if (mostrar)
				System.out
				.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- COLLECTED", jcmResponse, jcmResponse[1]));
		...
		case SR_PAY_VALID: // 0x23 PAY VALID
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- PAY VALID", jcmResponse, jcmResponse[1]));
		...
		case SR_PAY_STAY: // 0x24 PAY STAY
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- PAY STAY", jcmResponse, jcmResponse[1]));
		...
		case SR_RETURN_TO_BOX: // 0x25 RETURN TO BOX
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- RETURN TO BOX", jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, ACK, jcmMessage, true); // ACK
			break;

		case SR_RETURN_PAY_OUT_NOTE: // 0x26 RETURN PAY OUT NOTE +DATA
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- RETURN PAY OUT NOTE", jcmResponse,
						jcmResponse[1]));
			//Intento dispensar un billete y no pudo
			EventListenerClass.fireMyEvent(new MyEvent("noteError" + jcmId + "" + dispensingFromCassette));
		...
		case SR_RETURN_ERROR: // 0x2F RETURN ERROR
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- RETURN TO BOX", jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, ACK, jcmMessage, true); // ACK
			break;

		case SR_POWER_UP_WITH_BILL_IN_STACKER: // 0x42 POWER_UP_WITH_BILL_IN_STACKER / MOTOR_ERROR
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_POWER_UP_WITH_BILL_IN_STACKER",
		...
		case SR_ERR_RECYCLER_ERROR: // 0x4C RECYCLER ERROR
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_ERR_RECYCLER_ERROR", jcmResponse,
						jcmResponse[1]));
		...
		case SR_E_UNCONNECTED: // 0x00 UNCONNECTED
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_E_UNCONNECTED", jcmResponse, jcmResponse[1]));
			break;

		case SR_E_NORMAL: // 0x10 SR_E_NORMAL + DATA
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_E_NORMAL", jcmResponse, jcmResponse[1]));
			break;
			/*
			 * TODO: VALIDAR SI ES EXTENSION case SR_E_EMPTY: //0x11 SR_E_EMPTY if(mostrar)
			 * System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_E_EMPTY",
			 * jcmResponse,jcmResponse[1])); break;
			 */
		case SR_ERR_STACKER_FULL: // 0x43 STACKER_FULL
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- STACKER FULL", jcmResponse, jcmResponse[1]));
			break;
		case SR_ERR_STACKER_OPEN: // 0x44 SR_ERR_STACKER_OPEN
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_ERR_STACKER_OPEN", jcmResponse,
						jcmResponse[1]));
		...
		case SR_ERR_JAM_IN_ACCEPTOR: // 0x45 JAM_IN_ACCEPTOR
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_ERR_JAM_IN_ACCEPTOR", jcmResponse,
						jcmResponse[1]));
			break;
		case SR_ERR_JAM_IN_STACKER: // 0x46 SR_ERR_JAM_IN_STACKER
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_ERR_JAM_IN_STACKER", jcmResponse,
						jcmResponse[1]));
			break;
		...
		case SR_ERR_PAUSE: // 0x47 SR_ERR_PAUSE
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_ERR_PAUSE", jcmResponse, jcmResponse[1]));
			break;

		case SR_ERR_CHEATED: // 0x48 SR_ERR_CHEATED
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_ERR_CHEATED", jcmResponse, jcmResponse[1]));
			break;

		case SR_ERR_FAILURE: // 0x49 SR_ERR_FAILURE + DATA
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_ERR_FAILURE", jcmResponse, jcmResponse[1]));
			// TODO: Checar el DATA
			break;

		case SR_ERR_COMMUNICATION_ERROR: // 0x4A SR_ERR_COMMUNICATION_ERROR
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SR_ERR_COMMUNICATION_ERROR",
						jcmResponse, jcmResponse[1]));
			// TODO: Checar el DATA
			break;
		...
		case SCR_ENABLE_DENOM: // 0xC0 SCR_ENABLE_DENOM
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SCR_ENABLE_DENOM", jcmResponse, jcmResponse[1]));
			// TODO: Checar el DATA
		...
		case SCR_SECURITY_DENOM: // 0xC1 SCR_SECURITY_DENOM
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SCR_SECURITY_DENOM", jcmResponse, jcmResponse[1]));
			// TODO: Checar el DATA
			id003_format((byte) 6, (byte) 0xC4, jcmMessage, true); // CMD_DIRECTION
			break;
		case SCR_COMMUNICATION_MODE: // 0xC2 CMD_INHIBIT_ACCEPTOR
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- CMD INHIBIT ACCEPTOR", jcmResponse,
						jcmResponse[1]));
			// TODO: Checar el DATA
		...
		case SCR_INHIBIT: // 0xC3 SCR_INHIBIT
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- CMD SCR_INHIBIT ACCEPTOR", jcmResponse,	jcmResponse[1]));
			// TODO: Checar el DATA
			id003_format((byte) 5, (byte) 0x83, jcmMessage, true); // SSR_INHIBIT_ACCEPTOR
			break;
		case SCR_DIRECTION: // 0xC4 CMD_DIRECTION
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- CMD_DIRECTION", jcmResponse, jcmResponse[1]));
			// TODO: Checar el DATA
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			break;
		case SCR_OPTIONAL_FUNCTION: // 0xC5 CMD_DIRECTION
			// TODO: Checar el DATA
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SCR_OPTIONAL_FUNCTION", jcmResponse,
						jcmResponse[1]));
			break;
		...
		case SSRR_SECURITY: // 0x81 SSRR_SECURITY
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SSRR_SECURITY", jcmResponse, jcmResponse[1]));
			// TODO: Checar el DATA
		...
		case (byte) SSRR_INHIBIT: // 0x83 SSR_INHIBIT_ACCEPTOR
			// TODO: Checar el DATA
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SSR INHIBIT ACCEPTOR", jcmResponse,	jcmResponse[1]));
		...
		case SSRR_DIRECTION: // 0x84 SSRR_DIRECTION
			if (mostrar)
				System.out.println(
						baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SSRR_DIRECTION", jcmResponse, jcmResponse[1]));
			// TODO: Checar el DATA
		...
		case SSRR_VERSION_INFORMATION: // 0x88 SSRR_VERSION_INFORMATION (FIRMWARE)
			if (mostrar)
				System.out
				.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- FIRMWARE", jcmResponse, jcmResponse[1]));
		...
		case 0x40: // POWER_UP 0x40
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- POWER UP", jcmResponse, jcmResponse[1]));			
				currentOpertion = jcmOperation.PowerUp;
		...
		case 0x41: // POWER_UP_WITH_BILL_IN_ACCEPTOR * POWER_UP_WITH_BILL_IN_STACKER
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- POWER_UP_WITH_BILL_IN_ACCEPTOR",
						jcmResponse, jcmResponse[1]));
			break;
		...
		case (byte) 0xF0: // ALGUN EXTENDED
			...
			case (byte) 0xD0: // UNCONNECTED Recycler Unit is not connected.
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- SCR_E_RECYCLE_CURRENCY",jcmResponse, jcmResponse[1]));
			...
			case (byte) 0x00: // UNCONNECTED Recycler Unit is not connected.
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- UNCONNECTED",jcmResponse, jcmResponse[1]));
			// Mandamos el clear
			...
			case (byte) 0x10: // NORMAL
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- NORMAL",jcmResponse, jcmResponse[1]));
			...
			case (byte) 0x11: // EMPTY
				if (mostrar) System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- EMPTY",jcmResponse, jcmResponse[1]));
			...
			case (byte) 0x12: // FULL
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- FULL",jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			RaspiAgent.Broadcast(DeviceEvent.DEP_Status, "True");
			RaspiAgent.Broadcast(DeviceEvent.DEP_DetailStatus, "Online");
			RaspiAgent.Broadcast(DeviceEvent.DEP_CashUnitStatus, "Online");
			...
			case (byte) 0x1F: // BUSY
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- BUSY",jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			RaspiAgent.Broadcast(DeviceEvent.DEP_Status, "True");
			RaspiAgent.Broadcast(DeviceEvent.DEP_DetailStatus, "Online");
			RaspiAgent.Broadcast(DeviceEvent.DEP_CashUnitStatus, "Online");
			...
			case (byte) 0x40: // RECYCLER JAM
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- RECYCLER JAM",jcmResponse, jcmResponse[1]));
			...
			case (byte) 0x41: // DOOR OPEN
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- DOOR OPEN",jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			RaspiAgent.Broadcast(DeviceEvent.AFD_Status, "False");
			...
			case (byte) 0x42: // MOTOR ERROR
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- MOTOR ERROR",jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			RaspiAgent.Broadcast(DeviceEvent.AFD_Status, "False");
			...
			case (byte) 0x43: // EEPROM ERROR
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- EEPROM ERROR",jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			RaspiAgent.Broadcast(DeviceEvent.AFD_Status, "False");
			...
			case (byte) 0x44: //  PAY OUT NOTE ERROR 
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <---  PAY OUT NOTE ERROR ",jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			RaspiAgent.Broadcast(DeviceEvent.AFD_Status, "False");
			...
			case (byte) 0x45: //  RECYCLE BOX OPEN  
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <---  RECYCLE BOX OPEN",jcmResponse, jcmResponse[1]));
			//id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			id003_format((byte) 5, ACK, jcmMessage, true); // ACK
			RaspiAgent.Broadcast(DeviceEvent.AFD_Status, "False");
			...
			case (byte) 0x4A: //HARDWARE ERROR 
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- HARDWARE ERROR",jcmResponse, jcmResponse[1]));
			id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
			RaspiAgent.Broadcast(DeviceEvent.AFD_Status, "False");
			...
			case (byte) 0xA0:
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- TOTAL COUNT REQUEST", jcmResponse,
							jcmResponse[1]));
			...
			case (byte) 0xA1:
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- TOTAL COUNT CLEAR ", jcmResponse,
							jcmResponse[1]));
			...
			case (byte) 0xA2:
				...
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- CURRENT COUNT REQUEST", jcmResponse,
							jcmResponse[1]));
			...
			case SSRR_E_RECYCLE_SOFTWARE_VERSION: // 0x93
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- RECYCLER SOFTWARE VERSION REQUEST",
							jcmResponse, jcmResponse[1]));
				...
				if (!processingOperation) {
					...
					if (currentOpertion == jcmOperation.Reset || currentOpertion == jcmOperation.PowerUp) {
						System.out.println("RESET O POWERUP");
						id003_format((byte) 5, (byte) 0x40, jcmMessage, true); // RESET
					} else {

						if(currentOpertion == jcmOperation.Startup) {
							System.out.println("SSRR_E_RECYCLE_SOFTWARE_VERSION  STARTUP...");
							//Pedimos los conatadores y demas estatus, para no reinicar los jcms si es que estan arriba y bien.
							id003_format_ext((byte) 0x07, (byte) 0xf0, (byte) 0x20, (byte) 0x90, (byte) 0x40, (byte) 0x0,jcmMessage);			
						}
						else {
			...
			case (byte) 0x90:
				if (mostrar)
					System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- RECYCLE CURRENCY REQUEST", jcmResponse, jcmResponse[1]));
			...
			default:
				if (mostrar)
					System.out.println(
							baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- Algun Extended", jcmResponse, jcmResponse[1]));
				id003_format((byte) 5, (byte) 0x11, jcmMessage, true); // STATUS_REQUEST
				break;
			}
		...
		case (byte) 0x92: // UNIT INFORMATION RESPONSE
			if (mostrar)
				System.out.println(baitsToString("JCM[" + jcmId + "] [" + currentOpertion + "] <--- UNIT INFORMATION RESPONSE", jcmResponse,
						jcmResponse[1]));
		// TODO: Checar el DATA
	...
	public String baitsToString(String texto, byte[] baits, int total) {
		...
		for (int i = 0; i < baits.length; i++) {
			result += " [" + Integer.toHexString(baits[i] & 0xff) + "]";
			count++;
			if (count >= total) {
				i = baits.length + 1;
				break;
