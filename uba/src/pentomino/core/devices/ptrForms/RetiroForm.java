...
public class RetiroForm implements Printable {
	...
	public RetiroForm(double montoRetiro, String currentUser) {
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) {
		...
		g2d.drawString(currencyFormat.format(montoRetiro), mIzq + 60, 160);
		...
		g2d.drawString(currentUser, mIzq + 100, 270);		
